...
import top.tianqi.queue.dao.DelayTaskMapper;
import com.fasterxml.jackson.core.type.TypeReference;
import top.tianqi.queue.entity.DelayTask;
import top.tianqi.queue.enumeration.TaskClassEnum;
import top.tianqi.queue.task.OrderTask;
import top.tianqi.tools.queue.DelayQueueManager;
    ...
    public void run(ApplicationArguments args) {
        ...
        for (DelayTask delayTask : delayTasks) {
            if (delayTask.getClassId() == TaskClassEnum.ORDER_TASK.getCode()) {
                ...
                top.tianqi.tools.queue.DelayTask<OrderTask> task = JsonUtil.jsonToObject(delayTask.getTask(), new TypeReference<top.tianqi.tools.queue.DelayTask<OrderTask>>() {
                });
