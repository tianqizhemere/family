package top.tianqi.family.filter;
...
import top.tianqi.family.constant.HeaderConstant;
import top.tianqi.family.constant.OrderedConstant;
import top.tianqi.family.family.tools.utils.IpUtils;
import top.tianqi.family.family.tools.utils.JsonUtil;
import top.tianqi.family.family.tools.utils.LogUtil;
import top.tianqi.family.log.LogHelper;
import top.tianqi.family.log.Log;
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    return super.writeWith(fluxBody.buffer().map(dataBuffers -> {
                        ...
                        LogUtil.info("url:{},method:{},请求内容:{},响应内容:{},status:{},handleTime:{},requestId:{}",
