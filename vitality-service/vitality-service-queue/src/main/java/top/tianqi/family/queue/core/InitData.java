package top.tianqi.family.queue.core;
...
import top.tianqi.family.family.tools.queue.DelayQueueManager;
import top.tianqi.family.family.tools.utils.DateUtils;
import top.tianqi.family.family.tools.utils.JsonUtil;
import top.tianqi.family.queue.dao.DelayTaskMapper;
import top.tianqi.family.queue.entity.DelayTask;
import top.tianqi.family.queue.enumeration.TaskClassEnum;
import top.tianqi.family.queue.task.OrderTask;
    ...
    public void run(ApplicationArguments args) {
        ...
        for (DelayTask delayTask : delayTasks) {
            if (delayTask.getClassId() == TaskClassEnum.ORDER_TASK.getCode()) {
                ...
                top.tianqi.family.family.tools.queue.DelayTask<OrderTask> task = JsonUtil.jsonToObject(delayTask.getTask(), new TypeReference<top.tianqi.family.family.tools.queue.DelayTask<OrderTask>>() {
                });
